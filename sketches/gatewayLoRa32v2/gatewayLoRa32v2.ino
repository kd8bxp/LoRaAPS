...
// Oct 12, 2020 v 0.0.8 prepare to add aprs location updating
...
char SVR_NAME[] = "rotate.aprs.net";
#define SVR_PORT 14580

//Set The CallSign to use on APRS & passcode
#define callsign "KD8BXP-5" //ssid 10 typical denotes internet, igates, echolink, winlink, avrs, aprn, etc (maybe a good choice), ssid 5 typical denotes other networks (dstar, iphones, androids, ect) which maybe a good choice, ssid 12 one-way trackers maybe a good choice
//http://www.aprs.org/aprs11/SSIDs.txt
#define passcode ""

/*
    Get location on Google Maps:
    Latitude 39.536404 Longitude -84.381162
    APRS coordinate converter:
    http://digined.pe1mew.nl/?How_to:Convert_coordinates
    Latitude 3932.18N Longitude 08422.87W
*/
/* Define your location */
#define location "3932.18N/08422.87W" //this is the location used for sending gateway position, not used for other devices
#define sta_symbol "&"  //this should not be changed the symbol will display a G in a diamond (Gateway)
