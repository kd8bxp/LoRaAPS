...
msg = '{} {} {} {}'.format('N0CAL-01 Sunrise ',sunrise.replace("+00:00",""), 'Sunset ', sunset.replace("+00:00","")).encode(ENCODING)

print(msg)

print ("Sending page...")
ser = serial.Serial('/dev/ttyUSB0', 9600) #you may need to change the serial port
ser.write(msg)
ser.write(b'\n\r')
ser.close()
